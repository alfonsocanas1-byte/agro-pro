...
class AgroProApp:
    ...
    def render_ui(self):
        # Enrutamiento de Módulos (Navegación)
        ...
        with col_izq:
            ...
            # Subsección Alfonso
            st.subheader("🖼️ Dibujos de Alfonso Cañas Orduz")
            st.write("- Dibujos o fotografías en papel fotográfico: **$15.000**.")
            st.write("- Dibujos únicos y originales en papel normal: **$2.000**.")
            if st.button("Ingresar a galería ACOuniverso"):
            ...
            # Subsección Santiago
            st.subheader("☕ Fotografía de Santiago Arango")
            st.write("- Arte aplicado en pocillos (Mugs) de colección: **$38.000**.")
